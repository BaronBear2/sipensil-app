-- Migration: Phase 7 - Automasi Waktu
-- Created at: 2026-05-21

-- 1. Create RPC for Auto Updating Progress Steps Based on Calendar Dates
...
BEGIN
    ...
    WHERE tr.training_id = bt.id
      ...
      AND (
          (ts.last_selection_date IS NOT NULL AND CURRENT_DATE >= (ts.last_selection_date + INTERVAL '2 days'))
          OR
