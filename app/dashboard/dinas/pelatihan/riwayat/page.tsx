...
export default async function RiwayatPelatihanPage({ searchParams }: { searchParams: Promise<{ q: string }> }) {
    ...
    return (
        <div className="font-sans pb-20">
            <PageHeader 
                title="Riwayat Pelatihan (Legacy)" 
                description="Arsip pelatihan yang telah selesai dilaksanakan. Data ini tidak muncul di katalog pencaker." 
                backLink="/dashboard/dinas/pelatihan" 
                actions={
